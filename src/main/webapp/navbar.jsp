    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarsExample07">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="${pageContext.request.contextPath}/homepage.jsp">Home</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdown07">
              ...
              <li><a class="dropdown-item" href="${pageContext.request.contextPath}/PrepareInsertAnnuncioServlet">Crea un annuncio</a></li>
              ...
              <c:if test = "${userInfo.isAdmin()}">
              	...
              	<li><a class="dropdown-item" href="${pageContext.request.contextPath}/admin/PrepareInsertUtentiServlet">Inserisci Utente</a></li>
              </c:if>
            </ul> 
          </li>   
        </ul>
