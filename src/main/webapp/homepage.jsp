...
<body class="d-flex flex-column h-100">
	...
	<main class="flex-shrink-0">
		<div class="container">
			...
			<div
				class="alert alert-danger alert-dismissible fade show ${messaggio==null?'d-none':'' }"
				role="alert">
				${messaggio}
				<button type="button" class="btn-close" data-bs-dismiss="alert"
					aria-label="Close"></button>
						...
						<div class='card-body'>
							...
							<form method="post" action="ExecuteSearchAnnuncioServlet"
								...
								<a class="btn btn-primary btn-sm" data-bs-toggle="collapse"
									...
									aria-controls="collapseExample"> Inserisci Categorie </a>
		...
		<div class="container px-4 py-5" id="featured-3">
			<div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
				<div class="feature col">
					...
					<a href="PrepareSearchRegistaServlet" class="icon-link"> Vai
				...
				<div class="feature col">
					...
					<p>Paragraph of text beneath the heading to explain the
						heading. We'll add onto it with another sentence and probably just
						keep going until we run out of words.</p>
					<a href="PrepareSearchFilmServlet" class="icon-link"> Vai alla
