...
public class UtenteServiceImpl implements UtenteService{
	...
	public void inserisciNuovoConRuoli(Utente utenteInstance, String[] ruoli) throws Exception {
		...
		try {
			...
			for (int i = 0; i < ruoli.length; i++) {
				utenteInstance.getRuoli().add(ruoloDAO.findOne(Long.parseLong(ruoli[i])).orElse(null));
			}
